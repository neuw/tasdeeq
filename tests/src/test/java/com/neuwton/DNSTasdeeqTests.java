...
public class DNSTasdeeqTests {
    ...
    public void testDNSQuery() {
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq("google.com");
    ...
    public void testTXTRecords() {
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq("somewrong-domain-very-wrong-sub-domain.google.com", "TXT");
        assertNotNull(result);
    ...
    public void testUNKNOWNRecords() {
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq("google.com", "UNKNOWN");
        assertNotNull(result);
    ...
    public void testARecordOnly() {
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq("google.com", "A");
        assertNotNull(result);
        assertNotNull(result.getRecords("A"));
    }
    ...
    public void testAAndNSRecordOnly() {
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq("google.com", "A", "NS");
        assertNotNull(result);
        assertNotNull(result.getRecords("A"));
    ...
    public void testDNSQueryWrongWebsite() {
        ...
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq(domain);
        assertNotNull(result);
    ...
    public void testAAndNSRecordOnlyWrongWebsite() {
        String domain = "google-not-good"; // random domain
        DNSTasdeeqResult result = DNSTasdeeq.tasdeeq(domain, "A", "NS");
        assertNotNull(result);

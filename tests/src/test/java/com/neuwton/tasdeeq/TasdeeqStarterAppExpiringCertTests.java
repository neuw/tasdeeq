...
@TestPropertySource(properties = {
        ...
        "neuwton.tasdeeq.cert.domains.localhost.port=18494",
...
public class TasdeeqStarterAppExpiringCertTests {
    ...
    public static void init() throws Exception {
        ...
        MockServer.initServer(SERVER_PORT+"="+18494,KEYSTORE_PATH+"="+TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, KEYSTORE_PASSWORD+"="+CHANGE_IT);
    }

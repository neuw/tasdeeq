...
@TestPropertySource(properties = {
        ...
        "neuwton.tasdeeq.cert.domains.localhost.port=19494",
        "neuwton.tasdeeq.cert.domains.localhost.validate-chain=true",
...
public class TasdeeqStarterAppNotTrustedCertTests {
    ...
    public static void init() throws Exception {
        ...
        generateFullChainKeyStoreJKS(TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, 14);
        MockServer.initServer(SERVER_PORT+"="+19494,KEYSTORE_PATH+"="+TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, KEYSTORE_PASSWORD+"="+CHANGE_IT);
    }

...
@TestPropertySource(properties = {
        ...
        "neuwton.tasdeeq.cert.domains.localhost.port=20494",
...
public class TasdeeqStarterAppLongExpiringCertTests {
    ...
    public static void init() throws Exception {
        ...
        generateFullChainKeyStoreJKS(TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, 83);
        MockServer.initServer(SERVER_PORT+"="+20494,KEYSTORE_PATH+"="+TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, KEYSTORE_PASSWORD+"="+CHANGE_IT);
    }

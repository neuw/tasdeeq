...
@TestPropertySource(properties = {
        ...
        "neuwton.tasdeeq.cert.domains.localhost.port=18344",
...
public class TasdeeqStarterAppTrustedTests {
    ...
    public static void init() throws Exception {
        ...
        MockServer.initServer(SERVER_PORT+"="+18344,KEYSTORE_PATH+"="+TEMP_DIR+JKS_FILE_NAME_FULL_CHAIN, KEYSTORE_PASSWORD+"="+CHANGE_IT);
    }
